...
public class StaffTableModifier extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button btViewStaff = new Button("View");
        Button btInsertStaff = new Button("Insert");
        Button btUpdateStaff = new Button("Update");
        Button btClearStaff = new Button("Clear");
        HBox hBox = new HBox(5);
        hBox.getChildren().addAll(new Label("ID"), tfSSN,
                new Label("Course ID"), tfCourseId, (btViewStaff));
        ...
        btViewStaff.setOnAction(e -> showGrade());
        btInsertStaff.setOnAction(e -> showGrade());
